...
export default function EditAdmin() {
  ...
  return (
    <div>
      <PageMeta title="Edit Admin" description="Update admin user" />
      ...
      <div className="max-w-8xl mx-auto mt-6">
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
          ...
          <p className="text-gray-500 text-sm mb-6 dark:text-gray-400">
            Update the details below to modify the admin account.
          </p>
