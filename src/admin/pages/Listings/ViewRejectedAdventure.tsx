...
export default function ViewRejectedAdventure() {
  const { id } = useParams();
  ...
  useEffect(() => {
    ...
    setAdventure({
      id: numericId,
      adventureId: `ADV${3000 + numericId}`,
      vendorId: `VND${800 + numericId}`,
      name: `Adventure ${numericId}`,
      location: ["Manali", "Rishikesh", "Goa", "Jaisalmer"][
        numericId % 4
      ],
      category: ["Trekking", "Water Sports", "Safari"][
        numericId % 3
      ],
      price: 2000 + numericId * 150,
  ...
  const handleStatusUpdate = () => {
    const newStatus =
      adventure.status === "rejected" ? "approved" : "rejected";

    setAdventure({ ...adventure, status: newStatus });
    setShowModal(false);
  ...
  return (
    <div>
      <PageMeta
        ...
        description="View Adventure Details"
      />
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                View complete information and update adventure status.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <p className="text-sm text-gray-500">Adventure Name</p>
