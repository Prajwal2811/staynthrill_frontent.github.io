...
export default function ViewPendingAdventure() {
  const { id } = useParams();
  ...
  const handleAction = (type: "approved" | "rejected") => {
    setAdventure({ ...adventure, status: type });
    setShowModal(false);

    toast.success(
      type === "approved"
        ? "Adventure Approved Successfully"
        : "Adventure Rejected"
    );
  };
    ...
    <div>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                View complete information and approval status of the selected adventure.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <p className="text-sm text-gray-500">Adventure Title</p>
