...
const categories = ["Luxury", "Budget", "Resort", "Boutique"];
...
export default function PendingHotels() {
  ...
  const [hotels, setHotels] = useState<Hotel[]>(
    Array.from({ length: 30 }, (_, index) => ({
      ...
      name: `Hotel ${index + 1}`,
      location: ["Mumbai", "Delhi", "Goa", "Jaipur"][index % 4],
      category: categories[index % 4],
      pricePerNight: 2500 + index * 300,
    }))
  );
  ...
  return (
    <div>
      <PageMeta title="Pending Hotels" description="Manage Pending Hotels" />
      <PageBreadcrumb pageTitle="Pending Hotel Management" />
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Review and manage vendor hotel listings
            </p>
          </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left border-b dark:border-gray-700 text-gray-500 uppercase text-xs tracking-wider">
                ...
                <th onClick={() => handleSort("pricePerNight")} className="px-4 py-3 cursor-pointer">Price / Night</th>
                ...
                >
                  ...
                  <td className="px-4 py-4 text-center">
                    <div className="flex justify-center gap-4">
                      <button
                        onClick={() => navigate(`/hotels/pending/view/${hotel.id}`)}
